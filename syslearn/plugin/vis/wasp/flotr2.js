...
//console.log("ticksize="+axis.tickSize+" margin="+margin);
...
//console.log("axis.min="+axis.min+" axis.max="+axis.max);
...
axis.tickSize=Math.log10(Math.sqrt(2));
//console.log("axis.tickSize="+axis.tickSize+" linear="+Math.pow(o.base, axis.tickSize));
    ...
    for (i = min; i < max; i += axis.tickSize) {
      ...
      axis.ticks.push({v: decadeStart, label: o.tickFormatter(decadeStart.toFixed(decimals), {min : axis.min, max : axis.max})});

//console.log("decimals="+decimals+" v="+decadeStart);
